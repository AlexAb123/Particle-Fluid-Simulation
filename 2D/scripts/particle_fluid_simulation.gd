...
func _setup_shaders() -> void:
	...
	var clear_bucket_counts_shader := _create_compute_shader(load("res://2D/shaders/compute/clear_bucket_counts.glsl"))
	var count_buckets_shader := _create_compute_shader(load("res://2D/shaders/compute/count_buckets.glsl"))
	var prefix_sum_shader := _create_compute_shader(load("res://2D/shaders/compute/prefix_sum.glsl"))
	var scatter_shader := _create_compute_shader(load("res://2D/shaders/compute/scatter.glsl"))
	var densities_shader := _create_compute_shader(load("res://2D/shaders/compute/densities.glsl"))
	var forces_shader := _create_compute_shader(load("res://2D/shaders/compute/forces.glsl"))
